...
/*************************************************************
函数名称:SPI1_Config
函数原型:void SPI1_Config(void)
功    能:
SPI初始化：启用SPI1，主机模式，全双工，8位帧结构，波特率：72/16=4.5mhz
全局变量：
参    数:无
返 回 值:无
*************************************************************/
...
函数原型:u8 SPI1_ReadWriteByte(u8 TxData)
功    能:
SPI2,读写一个字节
全局变量：
参    数:u8 TxData 要写入的字节
返 回 值:u8 读取到的字节
*************************************************************/
...
功    能:
SPI初始化：启用SPI2，主机模式，全双工，8位帧结构，波特率：72/16=4.5mhz
全局变量：
参    数:无
返 回 值:无
*************************************************************/
...
函数原型:u8 SPI2_ReadWriteByte(u8 TxData)
功    能:
SPI2,读写一个字节
全局变量：
参    数:u8 TxData 要写入的字节
